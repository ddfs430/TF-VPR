...
logging.info(f"Triplets Train KMeans query set: {triplets_ds}")

########################################## get clustering ##########################################
# model.aggregation.initialize_cluster(args, test_ds, model)
model.aggregation.initialize_cluster(args, triplets_ds, model)

args.features_dim *= args.clusters_num
